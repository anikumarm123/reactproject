...
export const Home = () => {
  ...
  //   const product = await axios.get("http://nammacart-dev-lb-1671514857.ap-south-1.elb.amazonaws.com:8080/products/seller?sellerId=6108fb29f58bf55437a79e44");
  //   dispatch(listItem(product.data.data));
  // }
  ...
  return (
    <div className="listItem">
      ...
      {products.cart.product.map((data, index) => (
        <Card key={index} className="eachItem">
          <img src={data.image} />
          <CardContent>
            <Typography
              variant="body2"
